...
inclinic_data <- read_csv("In-Clinic Screening Photographer Worksheet 4.4.16-JK2_v2_10.1.19.csv")
View(inclinic_data)

cd4_data <- read_csv("CD4consolidated_updated_v2_10.1.19.csv")
View(cd4_data)
...
##----- BMS stop here --- the below is old 
## Ok I think that this is the correct combined and complete dataset, do you agree? 

##? Now what? 
##? Let me know any forward steps - the main question is do we have all the data that we need from Thailand?
##? If so, should we wrap this up since we seem relatively close, or should we defer to complete analysis on CMU Screening (DR, AMD glaucoma) and CMV QOL cohort? 
